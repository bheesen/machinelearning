...
kfz2$PreisEuro <- as.numeric(kfz2$PreisEuro) * wechselkurs  # Eurowert
kfz2$PreisEuroPrint <- sprintf("%s %9.2f ", "Euro", kfz2$PreisEuro)
head(kfz2, 7)
```
...
sum(is.na(kfz2$Zulassung))                               # Anzahl NA in Zulassung
kfz2$Zulassung[kfz2$Zulassung<1900&!is.na(kfz2$Zulassung)] # Zulassung vor 1900
kfz2$Zulassung[kfz2$Zulassung<1900] <- NA                 # durch NA ersetzen
sum(is.na(kfz2$Zulassung))                               # Anzahl NA in Zulassung
kfz2$Zulassung[kfz2$Zulassung>2021&!is.na(kfz2$Zulassung)] # Zulassung nach 2021
kfz2$Zulassung[kfz2$Zulassung>2021] <- NA                 # durch NA ersetzen
sum(is.na(kfz2$Zulassung))                               # Anzahl NA in Zulassung
```
...
mw <- mean(kfz2$Zulassung)                        # Mittelwert für Zulassung
mw                                               # Mittelwert anzeigen
mw <- mean(kfz2$Zulassung,na.rm=T)                # Mittelwert für Zulassung
...
kfz2.kopie <- kfz2                                 # Kopie für drop_na(,x) demo
sum(is.na(kfz2.kopie$Preis))                      # Anzahl NA in Preis
kfz2.kopie <- drop_na(kfz2.kopie, Preis)           # Löschen Zeilen mit NA in Preis
sum(is.na(kfz2.kopie$Preis))                      # Anzahl NA in Preis
#- NA-Werte durch Mittelwert ersetzen--------------------------------------------
head(filter(kfz2,Marke=="volkswagen"&PS==75),7)   # 7 Datensätze anzeigen
sum(is.na(kfz2.kopie$Zulassung))                  # Anzahl NA in Zulassung
kfz2$Zulassung<-ifelse(is.na(kfz2$Zulassung),mittelwert,kfz2$Zulassung)# NA->Mittelwert
sum(is.na(kfz2.kopie$Zulassung))                  # Anzahl NA in Zulassung
head(filter(kfz2,Marke=="volkswagen"&PS==75),7)   # 7 Datensätze anzeigen
```
