...
You can install the package machinelearning from [GitHub](https://github.com/) with:
...
The functions, data and tutorials are available once you activated the package:
